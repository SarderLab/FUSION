...
def main():
    ...
    image_name_list = [
        "suhaskc/histomicstk_extras:latest",
        "suhaskc/spot_annotation:latest",
        "suhaskc/spot_aggregation:latest",
        "samsam92/compreps:testupload",
        "sayatmimar/deployment_test:ifta-hpg",
        "sayatmimar/deployment_test:ptc-hpg",
        "samborder2256/ann_hierarchy:latest",
        "samborder2256/deepcell_plugin:latest",
        "suhaskc/ftx_plugin:latest",
